...
\begin{itemize}
 ...
 \item When performing comparisons in bash try to use double brackets \lstinline{[[ ]]} in favor of simple brackets \lstinline{[ ]}. Chances of making mistakes are lower although it won’t be portable to \lstinline{sh}
\end{itemize}
...
\begin{lstlisting}
  ...
  # Rememeber: NO SPACES or else bash treats them as separate args
\end{lstlisting}
