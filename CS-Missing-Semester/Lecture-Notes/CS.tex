...
\begin{description}
 ...
 \lstitem{x} delete character (equal to \lstinline{dl})
 \lstitem{s} substitute character (equal to \lstinline{xi})
 \lstitem{u} undo
 \lstitem{<C-r>} redo
...
\begin{description}
 ...
 \lstitem{/usr/local/bin} binaries for user compiled programs
